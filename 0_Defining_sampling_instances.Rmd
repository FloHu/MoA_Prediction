...
Creation of instances based on Nassos correstion from 05/08/2018
...
for(i in 1:10){
    name = paste("NCV_", as.character(i), sep="")
    Rep_Nest_CV_instance_newDrugs[[name]] = instance_creation(dataset = the_matrix_newDrugs, printTest = F)
}
