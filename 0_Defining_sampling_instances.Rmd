...
24/04/2018
After meeting Georg, turns out, for we have a small dataset, a bigger amount of fold is better. Thus the training set will countain more individuals. 
The testing sets can be aggregated afterwards, each individual being predicted by a model which did not learn from him.
