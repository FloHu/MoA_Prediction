...
if (file.exists("./data/programmatic_output/matrix_container_withextractions.rds")) {
...
# update
saveRDS(matrix_container, file = "./data/programmatic_output/matrix_container_withextractions.rds")
...
matrix_container_new = readRDS(file = "data/programmatic_output/matrix_container_new.rds")

if (file.exists("./data/programmatic_output/matrix_container_new_withextractions.rds")) {
...
# update
saveRDS(matrix_container_new, file = "./data/programmatic_output/matrix_container_new_withextractions.rds")
```
...
# results we already have
if (file.exists("./data/programmatic_output/stability_assessment.rds")) {
   stability_assessment <- readRDS("./data/programmatic_output/stability_assessment.rds")
} else {
...
# update
saveRDS(stability_assessment, file = "./data/programmatic_output/stability_assessment.rds")
...
#### Where does this file come from? ... probably temporarily adapted code above without saving
stability_assessment_new <- readRDS("./data/programmatic_output/stability_assessment_newmatrixcontainer.rds")
