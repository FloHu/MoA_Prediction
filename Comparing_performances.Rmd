...
ggsave("./plots/Probs_vs_conc.pdf", width = 87, height = 80, units = "mm")
```

Instead of concentration ranks, use n_signif on x-axis
...
ggsave("./plots/Probs_vs_conc_interactions.pdf", width = 87, height = 80, units = "mm")
```
