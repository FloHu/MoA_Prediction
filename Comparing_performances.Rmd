...
- Make a plot with median probability using the two highest concentrations vs. using all of them 
...
- show plot contrasting within vs. between dosages correlation
