...
Moreover, take with chemical features and using all dosages. Finally, top20pct/keepall seemed to 
...
for total AUCs (check top20pct), ROC curve shapes and, consequently, partial AUCs (see also above) 
...
would impact our performances as follows. I'm taking only top20pct and keepall for simplicity as 
...
tmp <- filter_container(matrix_container, models = c("classif.randomForest", "classif.glmnet"), 
  dosgs = "all", feats = c("top20pct", "keepall")) %>%
...
so the difference is not significant - use this information
# another idea: 
#   remove num saturated rings feature, then rerun model to 
#   prove point about uselessness of chemical structures
# theme: the skeptical biological machine learner
# überhaupt mehr statistische tests machen 
# wichtigkeit der normalverteilungsannahme!
# statistische berater am embl?
# power festlegen vor test
# viele tests: in data frame packen! (see help of wilcox.test!)
# %<>%
# %$%
