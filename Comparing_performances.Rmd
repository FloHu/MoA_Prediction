...
if (file.exists("./data/matrix_container_new_withextractions.rds")) {
   ...
   matrix_container_new$hyperparam_grid_name <- names(matrix_container$hyperparam_grid)
...
ggsave(filename = "./plots/matrix_container_new_perf.pdf", width = 16, height = 18)
...
plot_auc_vs_moa(tmp, xaxis = "process_broad", yaxis = "prob.moa_sd2", colourvar = "fitted_model", 
                facet_expr = quote(facet_wrap( ~ feat_preselect, ncol = 3)), additional_info = "")
ggsave(filename = "./plots/matrix_container_new_stablts.pdf", width = 16, height = 18)
