...
for (rownum in seq_len(nrow(matrix_container))) {
  ...
  my_match <- available_files[available_files == targetfile]
   ...
   matrix_container[rownum, c("perf_measures", "pred_data", "prob.moa_stabilities", "pred_data_with_n_signif", "thresh_vs_perf")] <- 
     list(list(perf_measures), list(pred_data), list(prob.moa_stabilities), list(pred_data_with_n_signif), list(thresh_vs_perf))
