...
ggplot(tmp, aes(x = s_score)) + 
   ...
   scale_fill_manual("Cellular target", values = c("#999999", "#ef8a62"), labels = c("Other", "DNA")) + 
...
ggplot(tmp2, aes(x = process_broad, y = n)) + 
   ...
   labs(x = "", y = "Count", title = "Number of observations per MoA")
...
ggplot(tmp3, aes(x = n)) + 
   ...
   labs(x = "Number of concentrations measured", y = "Number of drugs", 
        title = "Number of drugs vs. number of concentrations measured") + 
   scale_fill_discrete("Cellular target") + 
   scale_x_continuous(breaks = c(1, 2, 3, 4, 5, 6)) + 
   theme_bw() + 
   theme(text = element_text(size = 18))

ggsave("./plots/POSTER_conc_per_drug.pdf", width = 6, height = 6)
