...
```{r}
the_matrix_allDrugs <- readRDS("./data/programmatic_output/the_matrix_matrixcontainer_alldosg.rds")
...
moa_to_colour <- c(cell_wall = "#a6cee3", dna = "#1f78b4", protein_synthesis = "#b2df8a", 
  membrane_stress = "#33a02c", pmf = "#bababa", protein_qc = "#bababa", 
  oxidative_stress = "#bababa", unknown = "#bababa")
...
h <- Heatmap(matrix = m, 
  ...
  column_names_gp = gpar(fontsize = 3)) + row_annot
