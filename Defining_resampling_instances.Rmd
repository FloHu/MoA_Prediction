...
# cvtest_check_n_obs(cvinst_mostias$NCV_1, the_matrix_mostias)
# cvtest_check_n_obs(cvinst_alldosg$NCV_1, the_matrix_all)
...
# cvtest_check_indices(cvinst_mostias$NCV_1, the_matrix_mostias)
# cvtest_check_indices(cvinst_alldosg$NCV_1, the_matrix_all)
...
# cvtest_check_blocking(cvinst_alldosg$NCV_1, data = the_matrix_all)
# map(cvinst_alldosg, cvtest_check_blocking, data = data)
...
# finally, check if always all drugs occur in the test set also in the inner instances
...
# cvtest_all_drugs_in_test(nest_cvinst = cvinst_alldosg$NCV_1, data = the_matrix_all)
# cvtest_all_drugs_in_test(nest_cvinst = cvinst_mostias$NCV_1, data = the_matrix_mostias)
...
all(unlist(run_cv_tests(cvinst_alldosg, the_matrix_all)))
all(unlist(run_cv_tests(cvinst_mostias, the_matrix_mostias)))
```
