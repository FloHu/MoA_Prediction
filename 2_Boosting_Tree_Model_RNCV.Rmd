...
the_matrix_light = features_selection_variance(the_matrix, featStart = 3, percentTop = 5)
...
bt_hyp_param = makeParamSet(
    makeDiscreteParam("mfinal", values = seq(from = 100, to = 350, by = 50)), #seq(from = 100, to = 400, by = 20)
    makeDiscreteParam("maxdepth", values = c(2,3, 4)), #depth 1 = stump, 2 leaves for 4 classes, makes no sense 
