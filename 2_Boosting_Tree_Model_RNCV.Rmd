...
bt_hyp_param = makeParamSet(
    makeDiscreteParam("nrounds", values = c(500)), # number of trees
    makeDiscreteParam("max_depth", values = c(1, 3, 5)), #depth 1 = stump, 2 leaves for 4 classes, makes no sense 
...
result_xgb_5pc_4model = rep_nested_CV_run_4models(data_matrix = the_matrix_top5pct, model = "classif.xgboost", rep_instance = Rep_Nest_CV_instance, run_hyp_param =  bt_hyp_param, run_tuning = bt_tuning)
