...
swag = rep_nested_CV_run(data_matrix = the_matrix_top10pct, model = "classif.svm", rep_instance = Rep_Nest_CV_instance, run_hyp_param = svm_hyp_param, run_tuning = svm_tuning)
