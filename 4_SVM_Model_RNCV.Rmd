...
svm_hyp_param = makeParamSet(
    ...
    makeDiscreteParam("cost", values =  10**seq(-3,3)),
    makeDiscreteParam("gamma", values =  10**seq(-3,3))
)
...
result_SVM_10pc = rep_nested_CV_run(data_matrix = the_matrix_top10pct, model = "classif.svm", rep_instance = Rep_Nest_CV_instance, 
