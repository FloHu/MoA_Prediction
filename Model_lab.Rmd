...
```{r}
# (1) process mcl predictions for roc input according to one positive class 
...
plot_roc_mcl(resampled_multiclass, positive = "dna")
plot_roc_mcl(resampled_multiclass, positive = "membrane_stress")
plot_roc_mcl(resampled_multiclass, positive = "protein_synthesis")
