...
```{r florians_chunk}
# hyp_param_study(result_XGBT_10pc_allDrugs_tuneMMCE)
# plot_feat(result_XGBT_10pc_allDrugs_tuneMMCE)

plot_mean_perf(result_XGBT_10pc_allDrugs_tuneMMCE, meas = auc, moa = "dna") 
plot_ROC_allRep(result_XGBT_10pc_allDrugs_tuneMMCE)
plot_ROC_allRep(result_XGBT_10pc_allDrugs_tunePPV)
plot_ROC_allRep(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "all")
plot_prec_recall(result_XGBT_10pc_allDrugs_tuneMMCE)
plot_prec_recall(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "all")
plot_prec_recall(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "all")
plot_prec_recall(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "membrane_stress")
compare_ROC_2models(result_XGBT_10topWilcox_allDrugs_tuneMMCE, 
                    result_XGBT_10worstWilcox_allDrugs_tuneMMCE, 
                    moa = "all")
plot_ROC_allRep(result_XGBT_10wilcox_allDrugs_tuneMMCE)
ggsave(filename = "plot.pdf", compare_ROC_2models(result_greedy_XGBT_allFeat_allDrugs_tuneMMCE, 
                    result_XGBT_10pc_allDrugs_tuneMMCE, 
                    moa = "all"), width = 14)

ggsave(filename = "plot2.pdf", compare_ROC_2models(result_RF_27feat_allDrugs_tuneMMCE, 
                                                   result_XGBT_10pc_allDrugs_tuneMMCE, moa = "all"), 
       width = 14)

plot_ROC_optThres(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "dna") # only for one moa
plot_ROC_optThres(result_XGBT_10pc_allDrugs_tuneMMCE, moa = "membrane_stress") # only for one moa
