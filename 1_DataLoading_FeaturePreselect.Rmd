...
tmp = list()
tmp[1:6] = list(the_matrix_mostias_nochemfeats_2dosages)

matrix_container_new <- 
   tibble(datasets_included = rep("nichols_2011", 6), 
          drug_dosages =  rep("most2_interactions", 6), 
          feat_preselect = c("all", "all", "corr", "corr", "protCmplx", "protCmplx"), 
          chemical_feats = rep(FALSE, 6), 
