...
model_analysis(res_obj = lasso_30pc_all, matrix_container_line = matrix_container[155, ], 
               ...
               pdf_filename = "model_explanation_cell_wall.pdf", model_type = "lasso")
```
...
model_analysis(res_obj = bestRF_dna, matrix_container_line = matrix_container[18, ], 
               matrix_container_line_noChemFeat = matrix_container[17, ], moa = "dna",
               pdf_filename = "model_explanation_RF_dna.pdf", model_type = "tree", 
               feat_imp_thres = 0.9)
...
model_analysis(res_obj = res_best_dna, matrix_container_line = matrix_container_new[7, ], 
               moa = "dna", pdf_filename = "best_dna_results.pdf",
