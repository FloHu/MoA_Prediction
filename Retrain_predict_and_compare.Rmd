...
An attempt at characterising model quality of the multi-class model:
...
View(winners[winners$response != winners$truth, ])
```
...
res_knn # random forest result (r2_correct) returns ~ 0.08, so this is worse
# note that all this stuff is with cell_wall
res_knn$x
