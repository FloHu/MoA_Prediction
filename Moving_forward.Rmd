...
first)
* First show that the old approach using the OOB error leads to the same result (or didn't we use 
it already?)
* Then show that using the same approach with a multi-class model leads to similar performance. 

* Compare performance of previous point if using OOB error instead of test set errors. 
