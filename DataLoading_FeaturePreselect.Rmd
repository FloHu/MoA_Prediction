...
h$labels[order.dendrogram(d)] # order() not dispatch - why?
# easier:
...
p <- Heatmap(feats_cor_high, 
  ...
  clustering_distance_rows = my_distfun, # not needed here, for me to remember
  clustering_distance_columns = my_distfun, 
  row_names_gp = gpar(fontsize = 6), 
  column_names_gp = gpar(fontsize = 6), 
  cluster_columns = d, # alternatively set to TRUE - same outcome
  cluster_rows = d) # because also accepts hclust and dendrogram objects
